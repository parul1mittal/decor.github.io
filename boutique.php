...
<body>
    ...
    padding: 10px;length:45px;width:45px;" src="images/img/logo9.jpg" alt="homepage"  />
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="boutique.php">Choose Boutiques</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Choose Your favorite Catalogue</a></li>
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/boutique1.jpg">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3">
                            ...
                            <div class="widget clearfix">
                                ...
                                <div class="widget-body">
                                    <ul class="tags">
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=57" class="tag">
                                    Acessories
                                    </a> </li>
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=63" class="tag">
                                    Ethenic Wear
                                    </a> </li>
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=60" class="tag">
                                    Contemporary
                                    </a> </li>
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=62" class="tag">
                                    Cushion Cover
                                    </a> </li>
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=61" class="tag">
                                    Curtains
                                    </a> </li>
                                        <li> <a href="http://localhost/boutique/catalogue.php?res_id=64" class="tag">
                                    Western Wear
                                    </a> </li>
                                    <li> <a href="http://localhost/boutique/catalogue.php?res_id=54" class="tag">
                                    Bedsheets
                                    </a> </li>
                                    <li> <a href="http://localhost/boutique/catalogue.php?res_id=65" class="tag">
                                    Suits
                                    </a> </li>
                                    </ul>
                                </div>
									      ...
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="catalogue.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Food logo"></a>
															</div>
															<!-- end:Logo -->
															<div class="entry-dscr">
																<h5><a href="catalogue.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].' <a href="#">...</a></span>
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<p> 245 Reviews</p> <a href="catalogue.php?res_id='.$rows['rs_id'].'" class="btn theme-btn-dash">View Menu</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
