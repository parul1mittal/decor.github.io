...
<body style="background-image: url('images/login5.jpg'); background-repeat: repeat-x;">

  
<div class="container">
  <div class="info">
    <h1 style="color:black"><strong>Administration</strong> </h1><span> login Account</span>
  </div>
</div>
<div class="form">
