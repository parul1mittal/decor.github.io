...
<body class="fix-header">
    ...
    <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false">  <span><i class="fa fa-user f-s-20 "></i></span><span class="hide-menu">Customers</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="viewfeedback.php">view Customer</a></li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Store</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_boutique.php">Add Store</a></li>
                                
                            </ul>
                        </li>
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-female" aria-hidden="true"></i><span class="hide-menu">Catalogue</span></a>
                            <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper" style="height:1200px;">
                    ...
                    <div class="col-md-3">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from restaurant";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Boutiques Stores</p>
                                </div>
                            </div>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-female f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from dishes";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Boutique Catalogue</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2019 All rights reserved. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
