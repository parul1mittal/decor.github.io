    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    <button style="color:black" class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#mainNavbarCollapse">&#9776;</button>
...
<img style="margin-left: -240px;
    padding: 10px;length:45px;width:45px;" src="images/img/logo9.jpg" alt="homepage"  />
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/t8.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Take-Out </h1>
                    <h5 class="font-white space-xs">Find Boutique and Homedecors in relevant prices</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='boutique.php'" type="button" class="btn theme-btn btn-lg">Search Catalogue</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Boutique</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 380.721 380.721">
                                <g fill="#FFF">
                                    <path d="http://teespring.engineering/images/composer/ghost.png" /> </g>
                            </svg>
                            <h4><span>2. </span><i class="fa fa-female" style="font-size: 35px;padding:5px; " aria-hidden="true"></i>Order Clothes and home decor</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Catalogue of the Month</h2>
                    <p class="lead">The easiest way to Purchase Catalogue</p>
                </div>
                <div class="row">
									      ...
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																<h5><a href="catalogue.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
																<div class="product-name">'.$r['slogan'].'</div>
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="catalogue.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Boutique</h3>
                                    <p>We can provide many of the catalogue</p>
                                </div>
                            </div>
                        </div>
     ...
     viewBox="0 0 512 512" style="enable-background:;" xml:space="preserve"><g fill="#FFF">
<g>
    <g>
...
<g>
                                ...
                                <h3>Choose a Designer catalogue</h3>
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="catalogue.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="catalogue.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        ...
                        <a href="index.php"> <img style="length:185px;width:185px"src="images/img/logo6.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
